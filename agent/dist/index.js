...
async function main() {
    try {
        ...
        const response1 = await eren.invoke({
            messages: [
                new messages_1.HumanMessage("What is the ETH balance of 0xa32e1bd66b0824D63Bb3fEe4855750FCAb39e4aD?")
            ],
        });
        ...
        const response2 = await eren.invoke({
            messages: [
                new messages_1.HumanMessage("What is the current block number?")
            ],
        });
        ...
        const response3 = await eren.invoke({
            messages: [
                new messages_1.HumanMessage("What is the current gas price in Gwei?")
            ],
        });
        ...
        const response4 = await eren.invoke({
            messages: [
                new messages_1.HumanMessage("Check the balance of 0xa32e1bd66b0824D63Bb3fEe4855750FCAb39e4aD, get the current gas price, and calculate what 100 * 50 + 25 equals")
            ],
        });
        ...
        const response5 = await eren.invoke({
            messages: [
                new messages_1.HumanMessage("Can you get details for transaction 0x1234... if it exists?")
            ],
        });
